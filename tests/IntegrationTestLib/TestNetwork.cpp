...
#ifdef _WIN32
const std::string eganoDaemon = "eganod.exe";
#else
const std::string eganoDaemon = "eganod";
#endif
...
TestNodeConfiguration TestNetworkBuilder::buildNodeConfiguration(size_t index) {
  ...
  cfg.daemonPath = eganoDaemon; // default
  cfg.testnet = testnet;
  cfg.logFile = "test_eganod" + std::to_string(index) + ".log";
